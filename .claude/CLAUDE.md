...
You are working inside the **Legal AI Skills** repository by [KRASA AI](https://krasa.ai).

## What this repo is

A complete AI skills toolkit for lawyers. It contains:
...
- Industry page: https://krasa.ai/industries/legal
