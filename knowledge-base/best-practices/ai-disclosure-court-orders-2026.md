...
**Florida — statewide preemption — Florida Rule of General Practice and Judicial Administration 2.515(d)(2) (Fla. Sup. Ct. No. SC2026-0673, adopted May 28, 2026; effective June 15, 2026).** As of June 15, 2026, the three Florida circuit-level orders catalogued immediately above are *superseded* by a single statewide rule, and this entry's "patchwork of circuit-level orders" framing is, for Florida, now historical. The Florida Supreme Court amended Rule 2.515(d)(2) to make every signer of a court filing — attorney or self-represented litigant — represent by signature that all legal authorities cited in the filing exist and are accurately cited. The amendment is significant for this entry on four points. (i) *Model shift from disclosure to accuracy.* The circuit orders above followed a **disclose-the-tool** model (identify the AI program used, certify independent verification of AI-generated content). The statewide rule abandons tool disclosure entirely: it does not prohibit AI use, does not require the signer to disclose whether or which AI tool was used or at which stage, and instead attaches a **certify-the-citations-are-accurate** representation to the ordinary signature. The relevant duty is the accuracy of the cited authority, not the provenance of the draft — the same accuracy-over-provenance framing the Ninth Circuit's *LNU v. Blanche* states for sanctions ("it generally does not matter if the hallucination came from an AI tool or from the attorney's own reasoning"). (ii) *Express preemption of the circuit-and-chambers patchwork.* The amendment was adopted principally to replace the varied circuit administrative orders with a uniform statewide standard, and bars Florida lower courts from imposing separate AI disclosure or certification requirements by local administrative order, court policy, or chambers practice. In one amendment cycle the Miami-Dade AO 26-04, Broward AO 2026-03-Gen, and Palm Beach AO 2.109-4/26 are collapsed into the single signature-certification regime. (iii) *Enumerated first-instance sanction menu* — reprimand, contempt, striking the filing, dismissal, costs, attorneys' fees, and other remedies — available to a trial court on its own motion, making the contempt remedy a statewide first-instance trial-court tool rather than a disciplinary-referral escalation. (iv) *Equal coverage of self-represented litigants*, continuing the Palm Beach trend. The substantive AI-certification anchor-case treatment of this rule lives in `ai-hallucination-sanctions-2026.md` (the *In re Amendments* entry); recorded here because it changes the *disclosure-orders* map: a firm filing in Florida no longer maintains three separate circuit certification forms, and the jurisdiction index (below) should mark the Florida circuit rows as preempted-by-statewide as of June 15, 2026 rather than deleting them (the circuit orders remain the relevant authority for filings made before that date). The signature-as-certification design also removes the *certification-form-mismatch* failure mode this entry warns about (a substantively clean filing struck for omitting or paraphrasing a prescribed certification): there is no separate Florida AI form to mismatch — the signature itself carries the representation.
