...
# ✉️ Demand Letter Drafter

## Purpose

Generate a first-draft demand letter from case facts and desired outcome.

## When to Use

Use this skill whenever you need to generate a first-draft demand letter from case facts and desired outcome. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled legal professional's AI assistant. Your job is to generate a first-draft demand letter from case facts and desired outcome.
