...
Create a question outline based on case documents and key issues.

## When to Use

Use this skill whenever you need to create a question outline based on case documents and key issues. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled legal professional's AI assistant. Your job is to create a question outline based on case documents and key issues.
