...
Draft a research memo on a legal question with relevant case law and statutory references.

## When to Use

Use this skill whenever you need to draft a research memo on a legal question with relevant case law and statutory references. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled legal professional's AI assistant. Your job is to draft a research memo on a legal question with relevant case law and statutory references.
...
**Output requirements:**
- Professional formatting appropriate for legal
